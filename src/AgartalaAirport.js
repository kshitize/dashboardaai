...
const AgartalaAirport = () => (
  <AirportPage
    airportName="Agartala"
    canonicalUrl="/agartalaAirport"
    description="Airport information for Agartala (Maharaja Bir Bikram Airport)."
  />
);

export default AgartalaAirport;
...
// const AgartalaAirport = () => {
//   const { data: d, loading, error } = useAirportData("Agartala");
...
//           No row found for "Agartala" in the Google Sheet.
//         </div>
//       </section>
//     );
//   }
...
//         />
//         <link rel="canonical" href="/agartalaAirport" />
//       </Helmet>
...
//               {d["Airport"] || "—"} AIRPORT {/* B2 */}
//             </h2>

//             <h4 className="card-title fw-bold mb-2">
//               APD Name: {d["APD Name"] || "—"}  {/* E2 */}
//             </h4>

//             <p className="text-muted mb-3">Updated on : {d["Date of Updation"] || "—"}</p>
