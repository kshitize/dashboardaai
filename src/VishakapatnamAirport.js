...
const VishakapatnamAirport = () => {
  return (
    <>
      <Helmet>
        <title>Vishakapatnam Airport</title>
        <meta
          name="description"
      ...
      <section id="header">
        ...
        <div className="card-body">
          <h5 className="card-title">Airport Director</h5>
          <p className="card-text">
          <BsTelephone/><a href="tel:+4422560551">44-22560551</a>
          </p>
          <p className="card-text">
          <FiMail/>apdvishakapatnam@aai.aero
          </p>
        </div>
      </div>
...
export default VishakapatnamAirport